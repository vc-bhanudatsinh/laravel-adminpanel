...
<div class="dropdown">
    ...
    <div class="dropdown-menu">
        <a class="dropdown-item" href="{{ route( 'admin.daminis.index' ) }}"><i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.daminis.all' ) }}</a>
        {{-- @permission('create-damini') --}}
        <a class="dropdown-item" href="{{ route( 'admin.daminis.create' ) }}"><i class="fa fa-plus"></i> {{ trans( 'menus.backend.daminis.create' ) }}</a>
        {{-- @endauth --}}
        <a class="dropdown-item" href="@"><i class="fa fa-file"></i> {{ trans( 'menus.backend.daminis.import' ) }}</a>
    </div>
    </div>
</div>
