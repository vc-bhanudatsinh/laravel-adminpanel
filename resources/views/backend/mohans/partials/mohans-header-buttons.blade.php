...
<div class="dropdown">
    ...
    <div class="dropdown-menu">
        <a class="dropdown-item" href="{{ route( 'admin.mohans.index' ) }}"><i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.mohans.all' ) }}</a>
        @permission( 'create-mohan' )
        <a class="dropdown-item" href="{{ route( 'admin.mohans.create' ) }}"><i class="fa fa-plus"></i> {{ trans( 'menus.backend.mohans.create' ) }}</a>
        @endauth
        <a class="dropdown-item" href="@"><i class="fa fa-file"></i> {{ trans( 'menus.backend.mohans.import' ) }}</a>
    </div>
    </div>
</div>
