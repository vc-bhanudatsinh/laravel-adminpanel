<!--Action Button-->
@if( Active::checkUriPattern( 'admin/manishes' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.manishes.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.manishes.all' ) }}
            </a>
        </li>
        @permission( 'create-manish' )
            <li>
                <a href="{{ route( 'admin.manishes.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.manishes.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
