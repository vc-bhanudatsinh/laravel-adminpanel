<div class="box-body">
    ...
    <div class="row my-3">
        {{ Form::label('email', trans('Email'), ['class' => 'col-lg-2 text-center required']) }}
        <div class="col-lg-8">
    ...
    <div class="row my-3">
        {{ Form::label('profile_photo_path', trans('Image'), ['class' => 'col-lg-2 text-center required']) }}
    ...
    <div class="row my-3">
        {{ Form::label('status', trans('Status'), ['class' => 'col-lg-2 text-center required']) }}
        <div class="col-lg-8">
    ...
    <div class="row my-3">
        {{ Form::label('password', trans('Password'), ['class' => 'col-lg-2 text-center required']) }}
        <div class="col-lg-8">
