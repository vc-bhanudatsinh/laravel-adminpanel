...
<div class="w-100 d-flex justify-content-between align-items-center pt-3 px-3" style="border-bottom:2px solid #ccc;">
    <p><b class="lbindectionName text-dark">User Management</b> / Edit User</p>
    <p></p>
 </div>
@endsection
...
<div class=" p-3">
    <div class="col-md-12 bg-white py-3 px-2 shadow-lg bordertop-5 ">
      {{ Form::model($user, ['route' => ['admin.user.update', $user], 'class' => 'form-horizontal pt-3', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-user','files' => true]) }}
       {{ Form::token() }}
