{{ Form::open(['class' => 'form-horizontal hidden', 'role' => 'form', 'method' => 'post', 'id' => 'menu-add-custom-url']) }}
    <div class="form-group">
        {{ Form::label('name', trans('labels.backend.menu.field.name'), ['class' => 'col-lg-3 col-md-3 col-sm-3 control-label required']) }}
    ...
    <div class="form-group">
        {{ Form::label('url', trans('labels.backend.menu.field.url'), ['class' => 'col-lg-3 col-md-3 col-sm-3 control-label']) }}
        <div class="col-lg-9 col-md-9 col-sm-9">
          {{ Form::text('url', null, ['class' => 'form-control box-size mi-url', 'placeholder' => trans('labels.backend.menu.field.url')]) }}
        </div>
    </div>
    <div class="form-group">
        {{ Form::label('url', trans('labels.backend.menu.field.url_type'), ['class' => 'col-lg-3 col-md-3 col-sm-3 control-label']) }}
        <div class="col-lg-9 col-md-9 col-sm-9 ">
          <div class="radio">
    ...
    <div class="form-group">
        {{ Form::label('icon', trans('labels.backend.menu.field.icon'), ['class' => 'col-lg-3 col-md-3 col-sm-3 control-label', 'title' => trans('labels.backend.menu.field.icon_title')]) }}
        <div class="col-lg-9 col-md-9 col-sm-9">
    ...
    <div class="form-group view-permission-block">
        {{ Form::label('view_permission_id', trans('labels.backend.menu.field.view_permission_id'), ['class' => 'col-lg-3 col-md-3 col-sm-3 control-label']) }}
        <div class="col-lg-9 col-md-9 col-sm-9">
