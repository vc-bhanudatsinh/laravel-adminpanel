...
<div class="w-100 d-flex justify-content-between align-items-center pt-3 px-3" style="border-bottom:2px solid #ccc;">
     <p><b class="lbindectionName text-dark">Menu Management</b> / Menu List</p>
    <p></p>
 </div>
@endsection
...
@section('content')
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.menu.management') }}</h3>
        ...
        <div class="box-body">
            <div class="table-responsive data-table-wrapper">
                <table id="menu-table" class="table table-condensed table-hover table-bordered">
                    <thead>
                        <tr>
                    ...
                    <thead class="transparent-bg">
                        <tr>
                            <th>
                                {!! Form::text('first_name', null, ["class" => "search-input-text form-control", "data-column" => 0, "placeholder" => trans('labels.backend.menu.table.name')]) !!}
    ...
    <script>
        $(function() {
            ...
            var dataTable = $('#menu-table').dataTable({
                ...
                columns: [
                    {data: 'name', name: '{{config('access.menu_table')}}.name'},
                    {data: 'type', name: '{{config('access.menu_table')}}.type'},
                    {data: 'created_at', name: '{{config('access.menu_table')}}.created_at'},
