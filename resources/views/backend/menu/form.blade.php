        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="form-group">
                    {{ Form::label('categories', trans('labels.backend.menu.field.type'), ['class' => 'col-lg-4 col-md-4 col-sm-4 control-label required']) }}
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <div class="form-group">
                    {{ Form::label('name', trans('labels.backend.menu.field.name'), ['class' => 'col-lg-2 col-md-2 col-sm-2 control-label required']) }}
                    <div class="col-lg-10 col-md-10 col-sm-10">
                        {{ Form::text('name', null, ['class' => 'form-control box-size', 'placeholder' => trans('labels.backend.menu.field.name'), 'required' => 'required']) }}
                    </div>
                </div>
            </div>
        </div>
...
@section("after-scripts")
    ...
    <script type="text/javascript">
        Backend.Menu.selectors.formUrl = "{{route('admin.menu.getform')}}";
        Backend.Menu.init();
</script>
@endsection
