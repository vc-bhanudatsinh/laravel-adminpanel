...
<div class="dropdown">
    ...
    <div class="dropdown-menu">
        <a class="dropdown-item" href="{{ route( 'admin.settings.index' ) }}"><i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.settings.all' ) }}</a>
        <a class="dropdown-item" href="{{ route( 'admin.settings.create' ) }}"><i class="fa fa-plus"></i> {{ trans( 'menus.backend.settings.create' ) }}</a>
        <a class="dropdown-item" href="@"><i class="fa fa-file"></i> {{ trans( 'menus.backend.settings.import' ) }}</a>
    </div>
    </div>
</div>
