<!--Action Button-->
@if( Active::checkUriPattern( 'admin/viveks' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.viveks.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.viveks.all' ) }}
            </a>
        </li>
        @permission( 'create-vivek' )
            <li>
                <a href="{{ route( 'admin.viveks.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.viveks.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
