<!--Action Button-->
@if( Active::checkUriPattern( 'admin/lbs' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.lbs.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.lbs.all' ) }}
            </a>
        </li>
        @permission( 'create-lb' )
            <li>
                <a href="{{ route( 'admin.lbs.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.lbs.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
