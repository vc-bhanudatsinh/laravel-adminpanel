...
<li  @if(isActiveMenuItem($item)) aria-expanded="true" @else aria-expanded="false" @endif class="list-group-item  flex-lb-between" ><span><i class="fa {{ @$item->icon }}" aria-hidden="true"></i> &nbsp;&nbsp;{{ $item->name }}</span><i class="fa fa-angle-left lb-rotate" aria-hidden="true"></i></li>
