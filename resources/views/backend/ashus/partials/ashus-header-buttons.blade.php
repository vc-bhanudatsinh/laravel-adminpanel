<!--Action Button-->
@if( Active::checkUriPattern( 'admin/ashus' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.ashus.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.ashus.all' ) }}
            </a>
        </li>
        @permission( 'create-ashu' )
            <li>
                <a href="{{ route( 'admin.ashus.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.ashus.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
