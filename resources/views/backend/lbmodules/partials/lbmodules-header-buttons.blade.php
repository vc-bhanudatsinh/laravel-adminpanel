...
<div class="dropdown">
    ...
    <div class="dropdown-menu">
        <a class="dropdown-item" href="{{ route( 'admin.lbmodules.index' ) }}"><i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.lbmodules.all' ) }}</a>
        <a class="dropdown-item" href="{{ route( 'admin.lbmodules.create' ) }}"><i class="fa fa-plus"></i> {{ trans( 'menus.backend.lbmodules.create' ) }}</a>
        <a class="dropdown-item" href="@"><i class="fa fa-file"></i> {{ trans( 'menus.backend.lbmodules.import' ) }}</a>
    </div>
    </div>
</div>
