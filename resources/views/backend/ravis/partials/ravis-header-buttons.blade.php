...
<div class="dropdown">
    ...
    <div class="dropdown-menu">
        <a class="dropdown-item" href="{{ route( 'admin.ravis.index' ) }}"><i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.ravis.all' ) }}</a>
        @permission( 'create-ravi' )
        <a class="dropdown-item" href="{{ route( 'admin.ravis.create' ) }}"><i class="fa fa-plus"></i> {{ trans( 'menus.backend.ravis.create' ) }}</a>
        @endauth
        <a class="dropdown-item" href="@"><i class="fa fa-file"></i> {{ trans( 'menus.backend.ravis.import' ) }}</a>
    </div>
    </div>
</div>
