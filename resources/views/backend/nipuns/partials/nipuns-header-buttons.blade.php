<!--Action Button-->
@if( Active::checkUriPattern( 'admin/nipuns' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.nipuns.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.nipuns.all' ) }}
            </a>
        </li>
        @permission( 'create-nipun' )
            <li>
                <a href="{{ route( 'admin.nipuns.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.nipuns.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
