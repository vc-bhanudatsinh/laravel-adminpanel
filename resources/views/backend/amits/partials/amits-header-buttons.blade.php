<!--Action Button-->
@if( Active::checkUriPattern( 'admin/amits' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.amits.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.amits.all' ) }}
            </a>
        </li>
        @permission( 'create-amit' )
            <li>
                <a href="{{ route( 'admin.amits.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.amits.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
