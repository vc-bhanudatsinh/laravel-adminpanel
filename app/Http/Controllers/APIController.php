...
class APIController extends Controller
{
    ...
    public function throwusersame($message)
    {
        $message = "Username is same";
        return $this->setStatusCode(503)
            ->respondWithError($message);
    }
    public function throwuserexist($message)
    {
    ...
    public function throwpasswordinvalid($message)
    {
        $message = "This password is not valid";
        return $this->setStatusCode(401)
            ->respondWithError($message);
    }
    public function throwupdatepassword($message)
    {
